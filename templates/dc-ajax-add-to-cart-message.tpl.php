 ...
 */
?>
<?php $configuration['popup_image_style'] = 'products'; ?>
  ...
  <div class="new-item-details">
      <div class="left-product-info">
          <div class="product-image">
              <?php $image = file_load($product->field_image[LANGUAGE_NONE][0]['fid']);
                $vars = array(
                  'style_name' => $configuration['popup_image_style'],
                  'path' => $image->uri,
                  'width' => $image->width,
                  'height' => $image->height,
                );

                print render(theme_image_style($vars));
              ?>
          </div>
    </div>
